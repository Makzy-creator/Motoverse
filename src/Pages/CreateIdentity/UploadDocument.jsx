        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[43px] max-w-full text-center text-xl text-black font-text mq750:gap-[21px]">
          <div className="w-[1189px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
            <div className="w-[585px] rounded-full bg-gainsboro flex flex-row items-start justify-start gap-[56px] max-w-full">
              ...
              <div className="h-3 w-[520px] relative rounded-full bg-[#4D28FF] bg-[100%] z-[1]" />
            </div>
          </div>
        </div>
        {/* progress line ends */}
        <section className="w-[585px] h-[519px] pt-[60px] flex flex-row items-start justify-center max-w-full text-center text-20xl text-[#1F353C] font-text">
          <div className="flex flex-col items-start justify-start gap-[12px] max-w-full">
            ...
            <div className="pb-[60px] self-stretch relative text-base pt-[12px] text-green-900">
              <p className="font-bold">Eligible document: passport, driver’s license, or national ID card</p>  Make sure your identity document is valid and clearly visible. <br /> 
               Ensure all details are legible without any obstructions.
            </div>

            {/* main section starts */}

            <p className="text-base text-center justify-center w-[585px] h-[27px] text-[#7CA1AD] font-inherit">Upload either PNG, JPG, or PDF file types (5MB max)</p>
            <div className="w-[585px] h-[180px] mb-[40px] bg-[#E7E7F1] bg-[100%] rounded-lg 1px divide-solid border-dashed border-2 border-[#858597] cursor-pointer">
