...
const ProgressBarSet = ({
    ...
    return (
        <div className="self-stretch flex flex-row flex-wrap items-end justify-start gap-[37px] max-w-full text-left text-20xl text-green-900 font-karla mq800:gap-[18px]"
            style={progressBarSetStyle}>
            <div className="h-[437px] w-[100px] flex flex-row items-center justify-center relative gap-[35px]">
                <div className="h-[438px] w-px absolute !m-[0] top-[0px] left-[50px] box-border border-r-[1px] border-solid border-green-400" />
