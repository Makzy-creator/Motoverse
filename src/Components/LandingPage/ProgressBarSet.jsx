...
const ProgressBarSet = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-10 box-border min-w-[285px] min-h-[374px] max-w-full text-blue-700 mq450:pb-[36px] mq450:box-border"
        style={{}}
      >
        <div
          className="self-stretch [filter:drop-shadow(0px_10px_14.2px_rgba(0,_0,_0,_0.06))] rounded-xl flex flex-row items-start justify-start max-w-full"
          style={cardComponentStyle}
        >
          <div className="flex-1 flex flex-col items-start justify-start p-5 box-border gap-[20px] max-w-full">
            <h1
              className="m-0 self-stretch relative text-inherit tracking-[-0.02em] leading-[120%] font-bold font-inherit mq450:text-4xl mq450:leading-[28px] mq800:text-12xl mq800:leading-[37px]"
              style={vehicleValuationStyle}
            >
              {vehicleValuationVerificat}
            </h1>
