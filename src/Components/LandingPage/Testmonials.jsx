          ...
          <Slider {...settings}>
            <div className="self-stretch w-[343px] shadow-[0px_10px_14.2px_rgba(0,_0,_0,_0.04)] rounded-xl bg-green-0 overflow-hidden shrink-0 flex flex-col items-start justify-between p-5 box-border max-w-full">
              <div className="w-[292px] relative inline-block">
                ...
                verification checks reassured me, and handling the paperwork was
                a breeze with their help.
              </div>
            ...
            <div className="self-stretch w-[343px] shadow-[0px_10px_14.2px_rgba(0,_0,_0,_0.04)] rounded-xl bg-green-0 overflow-hidden shrink-0 flex flex-col items-start justify-between p-5 box-border max-w-full">
              <div className="w-[292px] relative inline-block">
                ...
                made everything so transparent and easy. The verification
                process gave me confidence, and I actually got a better price
                than I expected!
              </div>
            ...
            <div className="self-stretch w-[343px] shadow-[0px_10px_14.2px_rgba(0,_0,_0,_0.04)] rounded-xl bg-green-0 overflow-hidden shrink-0 flex flex-col items-start justify-between p-5 box-border max-w-full">
              <div className="w-[292px] relative inline-block">
                The step-by-step guidance was perfect. I uploaded my car, set
                the price, and the escrow service made the transaction
                completely secure. I highly recommend.
              </div>
            ...
            <div className="self-stretch w-[343px] shadow-[0px_10px_14.2px_rgba(0,_0,_0,_0.04)] rounded-xl bg-green-0 overflow-hidden shrink-0 flex flex-col items-start justify-between p-5 box-border max-w-full">
              <div className="w-[292px] relative inline-block">
                From verifying my car to finalizing the sale, every step was
                clear and straightforward. I felt supported and safe throughout
                the process.
              </div>
