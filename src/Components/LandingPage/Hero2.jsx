...
/*
bg-[url(/images/Frame19.svg)] bg-no-repeat bg-contain bg-cover flex flex-col p-[] items-center justify-start box-border relative gap-[60px] max-w-full text-left text-[39px] text-green-900 font-manrope mq450:gap-[15px] mq450:py-[51px] mq450:px-5 mq450:box-border mq1125:pt-[78px] mq1125:pb-[78px] mq1125:box-border mq800:gap-[30px] mq800:pl-[60px] mq800:pr-[60px] mq800:box-border
  ...
  return (
    ...
    <section className="">
        <div className="">
            ...
            <div className="flex md:block flex-col items-center justify-center gap-[42.8px]max-w-full text-6xl mq800:gap-[21px] mq1350:flex-wrap bg-transparent rounded-xl h-[447px] w-[343px] outline-none border-none">
                <Card
