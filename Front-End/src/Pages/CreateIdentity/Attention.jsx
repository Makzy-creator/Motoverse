...
const Attention = () => {
  ...
  return (
    <div className="w-[1440px] h-[1024px] max-w-full">
      <Navbar />
      <div className="w-full bg-white-50  flex flex-col items-start pt-[43px] justify-start gap-[43px] max-w-full font-manrope text-center text-20xl text-green-900 font-text mq675:gap-[21px]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[43px] max-w-full text-center text-xl text-black font-text mq750:gap-[21px]">
          <div className="w-[1189px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
            <div className="w-[585px] rounded-full bg-gainsboro flex flex-row items-start justify-start gap-[56px] max-w-full">
              ...
              <div className="h-3 w-[130px] relative rounded-full bg-[#4D28FF] z-[1]" />
            </div>
          </div>
        </div>
        {/* progress line ends */}
        ...
        <section className="w-[1440px] flex flex-col items-center justify-center max-w-full text-center text-20xl text-green-900 font-text pb-[185px]">
          <div className="w-[585px] flex flex-col items-start justify-start gap-[12px] max-w-full">
            <div className="self-stretch flex flex-col items-center justify-center py-0 px-5">
              <img src="/images/Attention.svg" alt="" loading="lazy" />
              ...
              <h6 className="text-inherit text-[20px] font-bold">
            ...
            <div className="self-stretch relative text-base text-green-900 ">
              <p className="flex flex-col gap-[12px]">
                {`Please write down your wallet’s phrase and keep it in a safe place. We recommend that you write down your backup phrase with pen and paper. The phrase is required to restore your Identity. `}{" "}
                <span className="block">{`Keep it safe, so you don’t lose your assets`}</span>
              </p>
            </div>
          </div>
        </section>
