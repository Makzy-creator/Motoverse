...
const BackupPhrase3 = () => {
  ...
  return (
    <div className="w-[1440px] h-[1024px] max-w-full bg-[#F3F3F6] bg-100%">
      <Navbar />
      <div className="self-stretch w-full flex flex-col items-start pt-[43px] justify-start gap-[43px] max-w-full font-manrope text-center text-20xl text-green-900 font-text mq675:gap-[21px]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[43px] max-w-full text-center text-xl text-black font-text mq750:gap-[21px]">
          <div className="w-[1189px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
            <div className="w-[585px] rounded-full bg-gainsboro flex flex-row items-start justify-start gap-[56px] max-w-full">
              ...
              <div className="h-3 w-[260px] relative rounded-full bg-[#4D28FF] bg-100% z-[1]" />
            </div>
          </div>
        </div>
        {/* progress line ends */}
        ...
        <section className="w-[1189px] flex flex-row items-start justify-center max-w-full text-center text-20xl text-green-900 font-text">
          <div className="w-[585px] flex flex-col items-start justify-start gap-[12px] max-w-full">
            ...
            <div className="w-[585px] h-[268px] py-[20px] rounded-lg border 1px solid border-green-900">
        ...
        <footer className="bg-[#F3F3F6] self-stretch flex flex-row items-start justify-between mt-[298px] px-[124px] py-[20px] gap-[20px] text-left text-base text-green-900 font-text border-t-[1px] border-solid border-green-200 mq450:pl-5 mq450:pr-5 mq450:box-border mq675:flex-wrap mq675:justify-center mq750:pl-[62px] mq750:pr-[62px] mq750:box-border">
          ...
          >
            <Link to="/BackupPhraseNext" className="" target="blanc">
