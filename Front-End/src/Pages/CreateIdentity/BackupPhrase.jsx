...
const BackupPhrase = () => {
  ...
  return (
    <div className="w-[1440px] h-[1024px] max-w-full bg-[#F3F3F6] bg-100%">
      <Navbar />
      <div className="self-stretch bg-[#F3F3F6] flex flex-col items-start pt-[43px] justify-start gap-[43px] max-w-full font-manrope text-center text-20xl text-green-900 font-text mq675:gap-[21px]">
