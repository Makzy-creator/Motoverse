          ...
          <div className="flex flex-col items-start justify-start gap-[12px] max-w-full">
            ...
            <div className="pb-[60px] self-stretch relative text-base pt-[12px] text-green-900">
              <p className="font-bold">
                Eligible document: passport, driver’s license, or national ID
                card
              </p>{" "}
              Make sure your identity document is valid and clearly visible.{" "}
              <br />
            ...
            <p className="text-base text-center justify-center w-[585px] h-[27px] text-[#7CA1AD] font-inherit">
              Upload either PNG, JPG, or PDF file types (5MB max)
            </p>
            <div className="w-[585px] h-[180px] mb-[40px] bg-[#E7E7F1] bg-[100%] rounded-lg 1px divide-solid border-dashed border-2 border-[#858597] cursor-pointer">
              <div className="self-stretch w-[585px] h-[180px] flex flex-row flex-wrap items-center justify-center gap-[10px] py-3 px-[12px] mq750:gap-[20px] ">
                <img
                  ...
                  loading="lazy"
                />
                <p className="self-stretch w-[561px] h-[44px] text-base font-inherit items-center justify-center text-[#858597]">
                  Drop File here <br />
                  or select file
                </p>
              </div>
