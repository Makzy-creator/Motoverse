  ...
  return (
    <section className="self-stretch w-full px-6 md:px-12 py-[50px] flex flex-col items-start bg-[#ECEDFF]">
      <div className="w-full sm:flex flex-1 sm:flex-col items-start gap-[60px]">
        <h1 className="self-stretch w-full font-karla text-[27px] tracking-[-0.5px] md:tracking-[-0.78px] leading-[120%] font-bold text-[#003855] mb-[60px] sm:mb-[0px]">
          Meet the team
        </h1>
        ...
        <div className="w-full h-fit block sm:grid grid-cols-3 gap-[60px]">
          <div className="flex flex-col h-fit sm:gap-4 pb-[30px]">
            ...
            <h1 className="self-stretch flex flex-col gap-[8px] font-[700] font-karla sm:text-[#004EB7] text-[#003855] sm:text-[22px] text-[18px] sm:leading-[120%] leading-[130%] tracking-[-0.1px]">
              Mario Andrade
