      ...
      <div className="flex items-center justify-center gap-[60px] max-w-full">
        ...
        <Link to="/" className="flex items-center justify-center gap-2">
          <img
            ...
            alt="Logo"
          />
          <h3 className="text-inherit uppercase text-[20px] md:text-inherit font-medium font-inherit whitespace-nowrap">
            Motoverse
          </h3>
        </Link>
        {/* Logo end */}
        ...
        <ul className="gap-[20px] text-[18px] hidden md:flex">
          <li>
